...
//		
//		readtest readE=new readtest();
//		readE.readExcel(new File(apipath+apiname));
//		
//		R_aa_mashup r_aa_mashup=new R_aa_mashup(readE.mashupList, readE.apiList);
//		r_aa_mashup.setMashup_2t1();
//		
//		boolean isok=  myWriteExcel.write_14(r_aa_mashup.getmyRulelist_mashup(),  savepath, savename, getMenuAndItems.getTitles_11());
//		if(isok){
//			str="完成";
//		}else{
//			str="失败,可能有相同名称文件被占用！";
